...
public class ProcessTitleTooLongException extends ProcesspediaException {

  private String processTitle;
  private int maxLengthAllowed;

  public ProcessTitleTooLongException() {}

  public ProcessTitleTooLongException(String processTitle, int maxLengthAllowed) {
