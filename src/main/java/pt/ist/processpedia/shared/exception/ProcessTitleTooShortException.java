...
public class ProcessTitleTooShortException extends ProcesspediaException {

  private String processTitle;
  private int minLengthAllowed;

  public ProcessTitleTooShortException() {}

  public ProcessTitleTooShortException(String processTitle, int minLengthAllowed) {
