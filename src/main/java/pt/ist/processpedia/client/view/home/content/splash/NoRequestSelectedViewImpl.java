...
public class NoRequestSelectedViewImpl extends SplashMessageViewImpl implements NoRequestSelectedView {

  public NoRequestSelectedViewImpl() {
    prepareView();
  }
  ...
  public void prepareView() {
    ...
    setSplashImage("themes/images/no-request-selected.png");
    setMessage(messages.noRequestSelected());
  }
}
